...
try {
    ...
    // Obtener claves de noticias del usuario desde user_news_api_keys (estructura normalizada)
    $stmt = $pdo->prepare('
    ...
    foreach ($userKeys as $key) {
        ...
        $keys[] = [
            ...
            'slug' => $provider['slug'] ?? '',
            'category' => $provider['category'] ?? 'news',
    ...
    error_log("Error en get_user_news_keys_safe.php: " . $e->getMessage());
