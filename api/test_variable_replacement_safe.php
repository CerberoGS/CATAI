...
try {
    ...
    $vsStoreGet = $ops['multi']['vs.store.get'];
    ...
    $testTemplate = "Bearer {{API_KEY}}";
    $result = replaceVariables($testTemplate, $params);
    
    $headerTest = $vsStoreGet['headers'][0];
    $originalHeaderValue = $headerTest['value'];
    $replacedHeaderValue = replaceVariables($originalHeaderValue, $params);
    ...
    json_out([
        ...
        'test_results' => [
            ...
            'header_template' => [
                'original' => $originalHeaderValue,
                'replaced' => $replacedHeaderValue,
                'contains_api_key_placeholder' => strpos($originalHeaderValue, '{{API_KEY}}') !== false,
                'contains_api_key_value' => strpos($replacedHeaderValue, $apiKeyPlain) !== false
            ],
